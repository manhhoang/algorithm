...
/******************************************************************************
 * Compilation: javac EvaluateDeluxe.java Execution: java EvaluateDeluxe Dependencies: Stack.java
 *
 * Evaluates arithmetic expressions using Dijkstra's two-stack algorithm. Handles the following
 * binary operators: +, -, *, / and parentheses.
 *
 * % echo "3 + 5 * 6 - 7 * ( 8 + 5 )" | java EvaluateDeluxe -58.0
 *
 *
 * Limitiations -------------- - can easily add additional operators and precedence orders, but they
 * must be left associative (exponentiation is right associative) - assumes whitespace between
 * operators (including parentheses)
 *
 * Remarks -------------- - can eliminate second phase if we enclose input expression in parentheses
 * (and, then, could also remove the test for whether the operator stack is empty in the inner while
 * loop) - see http://introcs.cs.princeton.edu/java/11precedence/ for operator precedence in Java
 *
 ******************************************************************************/
