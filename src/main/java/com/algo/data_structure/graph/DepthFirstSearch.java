...
/**
 * The <tt>DepthFirstSearch</tt> class represents a data type for determining the vertices connected
...
public class DepthFirstSearch {
    ...
    /**
     * Computes the vertices in graph <tt>G</tt> that are connected to the source vertex <tt>s</tt>.
     *
     * @param G the graph
