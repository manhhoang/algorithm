...
public final class In {
  ...
  /**
   * Returns true if this input stream has a next line. Use this to know whether the next call to
   * {@link #readLine()} will succeed.
   * <p>
   * Functionally equivalent to {@link #hasNextChar()}.
   *
   * @return <tt>true</tt> if this input stream has a next line; <tt>false</tt> otherwise
   */
  ...
  /**
   * Returns true if this input stream is empty (including whitespace). Use this to know whether the
   * next call to {@link #readChar()} will succeed.
   * <p>
   * Functionally equivalent to {@link #hasNextLine()}.
   *
   * @return <tt>true</tt> if this input stream is empty (including whitespace); <tt>false</tt>
   *         otherwise
   */
  ...
  /**
   * Reads the next token from this input stream, parses it as a <tt>int</tt>, and returns the
   * <tt>int</tt>.
   *
  ...
  /**
   * Reads the next token from this input stream, parses it as a <tt>double</tt>, and returns the
   * <tt>double</tt>.
   *
  ...
  /**
   * Reads the next token from this input stream, parses it as a <tt>float</tt>, and returns the
   * <tt>float</tt>.
   *
  ...
  /**
   * Reads the next token from this input stream, parses it as a <tt>long</tt>, and returns the
   * <tt>long</tt>.
   *
  ...
  /**
   * Reads the next token from this input stream, parses it as a <tt>short</tt>, and returns the
   * <tt>short</tt>.
   *
  ...
  /**
   * Reads the next token from this input stream, parses it as a <tt>byte</tt>, and returns the
   * <tt>byte</tt>.
   * <p>
  ...
  /**
   * Reads the next token from this input stream, parses it as a <tt>boolean</tt> (interpreting
   * either <tt>"true"</tt> or <tt>"1"</tt> as <tt>true</tt>, and either <tt>"false"</tt> or
   * <tt>"0"</tt> as <tt>false</tt>).
   *
