/**
 * Compilation: javac Quick.java Execution: java Quick < input.txt Dependencies: StdOut.java
 * StdIn.java Data files: http://algs4.cs.princeton.edu/23quicksort/tiny.txt
 ...
 * <p>
 * % java Quick < words3.txt all bad bed bug dad ... yes yet zoo [ one string per line ]
 * <p>
 * <p>
 ...
 * <p>
 * <p>
 * The <tt>Quick</tt> class provides static methods for sorting an array and selecting the ith
...
import com.algo.algorithm.util.StdRandom;
...
public class QuickSort {
    ...
    /**
     * Rearranges the array so that a[k] contains the kth smallest key; a[0] through a[k-1] are less
     * than (or equal to) a[k]; and a[k+1] through a[N-1] are greater than (or equal to) a[k].
     *
     * @param a the array
