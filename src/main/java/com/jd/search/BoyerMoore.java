...
/******************************************************************************
 * Compilation: javac BoyerMoore.java Execution: java BoyerMoore pattern text Dependencies:
 * StdOut.java
 *
 * Reads in two strings, the pattern and the input text, and searches for the pattern in the input
 * text using the bad-character rule part of the Boyer-Moore algorithm. (does not implement the
 ...
 *
 * % java BoyerMoore rab abacadabrabracabracadabrabrabracad text: abacadabrabracabracadabrabrabracad
 * pattern: rab
 *
...
/**
 * The <tt>BoyerMoore</tt> class finds the first occurrence of a pattern string in a text string.
 * <p>
 * This implementation uses the Boyer-Moore algorithm (with the bad-character rule, but not the
 * strong good suffix rule).
 * <p>
 * For additional documentation, see <a href="http://algs4.cs.princeton.edu/53substring">Section
